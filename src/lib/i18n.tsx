...
const dict: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    arrivalNextDayHelp: "Se a chegada ocorre no dia seguinte ao dia da partida, marque esta opção.",
  ...
  en: {
    ...
    arrivalNextDayHelp: "If arrival happens on the day after departure, check this option.",
  ...
  es: {
    ...
    arrivalNextDayHelp: "Si la llegada ocurre al día siguiente de la salida, marca esta opción.",
