...
const dict: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    arrivalNextDayHelp: "Nota: Este voo chega no dia seguinte à partida. Para o planejamento, consideramos o check-in da hospedagem para o dia posterior à data de saída do voo.",
    ...
    stayCheckinNextDayNote: "Como o voo chega no dia seguinte à partida, o check-in da hospedagem foi configurado para o dia seguinte à data de saída do voo.",
  },
  en: {
    appName: "CalenTrip",
    language: "Language",
    ...
    arrivalNextDayHelp: "Note: This flight arrives the day after departure. For planning, we consider the accommodation check-in on the day after the flight’s departure date.",
  ...
  es: {
    ...
    arrivalNextDayHelp: "Nota: Este vuelo llega al día siguiente de la salida. Para la planificación, consideramos el check-in del alojamiento para el día posterior a la fecha de salida del vuelo.",
