                ...
                <>
                  ...
                  {stayCandidates.length > 1 ? (
                    <div>
                      ...
                      <Select className="mt-1" value={String(stayChosenIdx ?? 0)} onChange={(e) => { const i = Number((e.target as HTMLSelectElement).value); const c = stayCandidates[i]; chooseStayCandidate(i, c); }}>
