...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (status === "authenticated" && !redirected.current) {
      ...
      try { router.push(callbackUrl || "/profile"); } catch {}
    }
  ...
  return (
    <div className="container-page py-6 space-y-4">
      <div className="flex items-center gap-3">
        <button type="button" className="rounded-md p-1 border border-zinc-200 dark:border-zinc-800 text-zinc-500 hover:text-zinc-700" onClick={() => router.push("/flights/search")}>
